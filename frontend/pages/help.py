...
class HelpPage(QWidget):
    def __init__(self):
        ...
        self.instructionsLabel = TextLabel(
            self, "helpPageInstructionsLabel", "How to Use Blood Emporium", Font(12)
        )
        self.instructionsDescription = TextLabel(
            self, "helpPageInstructionsDescription", d, Font(10)
        )
        self.instructionsDescription.setWordWrap(True)

        self.contactLabel = TextLabel(
            self, "helpPageContactLabel", "Contact Me", Font(12)
        )

        self.contactDiscordRow = QWidget(self)
        self.contactDiscordRow.setObjectName("helpPageContactDiscordRow")
        self.contactDiscordRowLayout = RowLayout(
            self.contactDiscordRow, "helpPageContactDiscordRowLayout"
        )
        ...
        self.contactDiscordLabel = HyperlinkTextLabel(
            self.contactDiscordRow,
            "helpPageContactDiscordLabel",
            "Discord",
            "https://discord.gg/J4KCqJJuaM",
            Font(10),
        )

        self.contactTwitterRow = QWidget(self)
        self.contactTwitterRow.setObjectName("helpPageContactTwitterRow")
        self.contactTwitterRowLayout = RowLayout(
            self.contactTwitterRow, "helpPageContactTwitterRowLayout"
        )
        ...
        self.contactTwitterLabel = HyperlinkTextLabel(
            self.contactTwitterRow,
            "helpPageContactTwitterLabel",
            "Twitter",
            "https://twitter.com/initiationmusic",
            Font(10),
        )
